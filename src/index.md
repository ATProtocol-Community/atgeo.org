...
We'd like app developers to articulate their use cases, in order to triage what further problems the ATGeo working group should try to solve. We'd also like volunteers to help develop solutions.

## Help wanted

We need your help to refine and improve the ATGeo lexicon and services!!! Please join us on <!-- TODO: find the atproto community discourse server --> under the _#atgeo_ tag. 
